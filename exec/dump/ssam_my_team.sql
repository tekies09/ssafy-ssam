...
CREATE TABLE `my_team` (
  `my_team_id` bigint NOT NULL AUTO_INCREMENT,
  `my_team_name` varchar(255) DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`my_team_id`),
  KEY `FKs0d6tcikax42grly7frxu20xn` (`user_id`),
  CONSTRAINT `FKs0d6tcikax42grly7frxu20xn` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `my_team` VALUES (1,'야알못',11),(3,'팀이 만들어질까요',2),(4,'JH MINIONS',3),(8,'새만의 팀',8);
